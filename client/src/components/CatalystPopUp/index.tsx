    ...
    >
      <div className={`body-background p-5 rounded-2xl shadow-xl`}>
        <div className="flex flex-row items-center">
          <p className="text-2xl font-medium">We’re on Catalyst F9!</p>
          <FontAwesomeIcon
        ...
        <p className="mt-5">
          TosiDrop is building cross-chain infrastructure for Ergo and Cardano.
          Check out our catalyst proposals on Project Catalyst F9 and vote for
          us! Let’s build a better future together.
        </p>
